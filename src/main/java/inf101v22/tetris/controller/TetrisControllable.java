...
/** 
 * Implemnting this interface allows an object to be the controller for a game of tetris. 
 * 
...
public interface TetrisControllable {
    ...
    */
     ...
     */
    void rotateFallingPieceLeft();

     /**
     * Rotates a falling tetris piece right
     */
    void rotateFallingPieceRight();
    ...
    */
    ...
    /**
     * Saves the score of the current game to the scoreboard
